...
def image_to_inp(img, device):
    ...
    return img_out
def get_stop_patch_from_img(input_dim=201):
    stop_ori = cv2.imread('imgs/stop/stop1.jpg')
...
def yolo_test(num_test, patch_test):
    ...
    #ori_stop
    original_stop,map_4_patches,map_4_stop,patch_four=get_stop_patch_from_img(input_dim=201)
...
#                 writer.add_scalar('misc/avg_grad_sum', avg_grad_sum, i)
                ...
                writer.add_image('patch', patch_f.squeeze(), i)
