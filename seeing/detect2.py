...
from helper.preprocess import prep_image,prep_image2, inp_to_image
...
def arg_parse():
    ...
    parser.add_argument("--images", dest = 'images', help = 
                        ...
                        default = "imgs2", type = str)
    parser.add_argument("--det2", dest = 'det2', help =
...
#        scale_indices = li
    ...
    if not os.path.exists(args.det2):
        os.makedirs(args.det2)
