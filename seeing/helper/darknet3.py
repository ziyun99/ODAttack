...
from helper.util import count_parameters as count
from helper.util import convert2cpu as cpu
from helper.util import predict_transform
...
class Darknet(nn.Module):
    ...
    def forward(self, x, CUDA):
        ...
        outputs2 = {}   #We cache the outputs for the leaky layer
        ...
        for i in range(len(modules)):        
            ...
            if module_type == "convolutional" or module_type == "upsample" or module_type == "maxpool":
                ...
                if module_type == "convolutional":
                   if i<79:#==3 or i==10 or i==35 or i==60 or i==73:
            #        print(i)
            #        print(x.shape)
                       outputs2[step] = x
                       step=step+1
