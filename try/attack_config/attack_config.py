...
class BaseConfig(object):
    ...
    def __init__(self):
        ...
        Set the defaults.
        """
        self.attack_method = "EOTB_attack"
...
class Try(ReproducePaperObj):
    ...
    def __init__(self):
        ...
        self.img_dir = "inria/Train/pos"
        self.lab_dir = "inria/Train/pos/yolo-labels"
        self.cfgfile = "object_detectors/cfg/yolo.cfg"
        self.weightfile = "object_detectors/weights/yolov2.weights"
        self.printfile = "attack_config/nps_values.txt"
